  ...
  try {
    ...
    (tasksData || []).forEach((t: any) => {
      ...
      allItems.push({
        ...
        rawStatus,
        priority,
        userId: t.assigned_to || t.created_by || null,
        userName: assignedUser ? assignedUser.fullName : (creatorUser ? creatorUser.fullName : "Unassigned"),
        userRole: assignedUser ? assignedUser.role : (creatorUser ? creatorUser.role : "Team Member"),
        userAvatar: assignedUser?.avatarUrl || creatorUser?.avatarUrl,
    ...
    (subTasksData || []).forEach((st: any) => {
      ...
      allItems.push({
        ...
        rawStatus,
        priority: "Standard",
        userId: st.assigned_to || st.created_by || null,
        userName: assignedUser ? assignedUser.fullName : (creatorUser ? creatorUser.fullName : "Unassigned"),
        userRole: assignedUser ? assignedUser.role : (creatorUser ? creatorUser.role : "Team Member"),
        userAvatar: assignedUser?.avatarUrl || creatorUser?.avatarUrl,
    ...
    (ticketsData || []).forEach((tk: any) => {
      ...
      allItems.push({
        ...
        rawStatus,
        priority,
        userId: tk.assignee_id || tk.creator_id || null,
        userName: assignedUser ? assignedUser.fullName : (creatorUser ? creatorUser.fullName : "Unassigned"),
        userRole: assignedUser ? assignedUser.role : (creatorUser ? creatorUser.role : "Team Member"),
        userAvatar: assignedUser?.avatarUrl || creatorUser?.avatarUrl,
