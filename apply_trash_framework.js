...
async function applyMigration(url) {
    ...
    try {
        ...
        const sqlPath = path.join(__dirname, 'supabase', 'migrations', '20260621000000_universal_trash_framework.sql');
        const sql = fs.readFileSync(sqlPath, 'utf8');
        
        await client.query(sql);
        console.log("Successfully applied universal trash framework migration.");
        await client.end();
        return true;
    } catch (e) {
