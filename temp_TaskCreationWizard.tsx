    ...
    >
        ...
        <div className="space-y-3">
            ...
            <div>
              ...
              <div className="mb-3">
                ...
                <label 
                  ...
                  className={`flex items-center justify-center gap-2 w-full py-2 rounded-lg text-sm font-bold border border-dashed cursor-pointer transition-all ${
                    isLightMode 
          ...
          <div className={`p-3.5 rounded-xl border ${"bg-surface border-border shadow-[var(--shadow-ambient)]"}`}>
            ...
            {isAddingField && (
              <div className={`p-3 rounded-lg border mb-3 flex flex-col sm:flex-row items-end gap-3 ${isLightMode ? "bg-amber-50/50 border-amber-200" : "bg-amber-500/[0.05] border-amber-500/20"}`}>
