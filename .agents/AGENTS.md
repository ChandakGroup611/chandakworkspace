...
4. **Vulnerability Scan**: Always run `npm audit` to check for Hostinger / dependency vulnerabilities. If any exist, you must resolve them first before deploying. Only deploy if the scan passes (0 vulnerabilities).
