...
const fixSQL = `
-- ============================================================================
-- FINAL FUNCTION OVERWRITES TO FIX LEGACY REFERENCES (v2)
-- ============================================================================
...
const parts = content.split('-- FINAL FUNCTION OVERWRITES TO FIX LEGACY REFERENCES');
fs.writeFileSync('guaranteed_schema.sql', parts[0] + fixSQL + '\n-- POLICIES DEFERRED TO END --' + content.split('-- POLICIES DEFERRED TO END --')[1]);
console.log('Fixed functions (v2) appended before policies.');
