...
CREATE OR REPLACE FUNCTION "public"."can_see_workspace"("p_workspace_id" "uuid", "p_owner_id" "uuid", "p_visibility_settings" "jsonb" DEFAULT NULL::"jsonb") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
    IF public.is_super_admin() THEN RETURN TRUE; END IF;
    IF COALESCE((p_visibility_settings ->> 'public')::boolean, false) = true THEN RETURN TRUE; END IF;
    IF auth.uid() = p_owner_id THEN RETURN TRUE; END IF;
    IF p_owner_id IS NOT NULL AND EXISTS (
        SELECT 1 FROM public.user_master 
        WHERE id = p_owner_id AND manager_id = auth.uid()
    ) THEN RETURN TRUE; END IF;
    ...
    IF EXISTS (
        ...
        WHERE wt.workspace_id = p_workspace_id AND wt.is_deleted = false
...
ALTER FUNCTION "public"."can_see_workspace"("p_workspace_id" "uuid", "p_owner_id" "uuid", "p_visibility_settings" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."check_task_access"("target_task_id" "uuid", "target_user_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  -- Super admin check
...
CREATE OR REPLACE FUNCTION "public"."create_workspace_stats"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."create_workspace_stats"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."generate_series_code"("p_prefix" character varying) RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."generate_series_code"("p_prefix" character varying) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."workspaces" (
    ...
    "workspace_type" "text" DEFAULT 'WORKSPACE'::"text",
    "visibility_settings" "jsonb" DEFAULT '{"public": false}'::"jsonb"
);
...
CREATE OR REPLACE FUNCTION "public"."hierarchy_subws_count"("ws" "public"."workspaces") RETURNS integer
...
BEGIN
    ...
    SELECT COUNT(*) INTO total_subws FROM workspace_tree;
    RETURN total_subws;
END;
$$;


ALTER FUNCTION "public"."hierarchy_subws_count"("ws" "public"."workspaces") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."hierarchy_task_count"("ws" "public"."workspaces") RETURNS integer
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    AS $$
DECLARE
    total_tasks INTEGER;
BEGIN
    WITH RECURSIVE workspace_tree AS (
        SELECT id FROM public.workspaces WHERE id = ws.id
        UNION ALL
        SELECT w.id FROM public.workspaces w
        INNER JOIN workspace_tree wt ON w.parent_workspace_id = wt.id
        WHERE w.is_deleted = false
    ...
    INTO total_tasks FROM workspace_tree wt
...
ALTER FUNCTION "public"."hierarchy_task_count"("ws" "public"."workspaces") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."set_task_code"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    IF NEW.parent_task_id IS NOT NULL THEN
        IF NEW.task_code IS NULL THEN NEW.task_code := public.generate_series_code('STK'); END IF;
    ELSE
        IF NEW.task_code IS NULL THEN NEW.task_code := public.generate_series_code('TSK'); END IF;
    END IF;
    RETURN NEW;
END;
$$;
...
ALTER FUNCTION "public"."set_task_code"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_workspace_code"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."set_workspace_code"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."sync_task_owner_to_participants"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."sync_task_owner_to_participants"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_subworkspace_count"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_subworkspace_count"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_task_count"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    IF TG_OP = 'INSERT' THEN
...
ALTER FUNCTION "public"."update_task_count"() OWNER TO "postgres";
...
ALTER TABLE "public"."series_tracker" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."task_participants" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "task_participants_participation_role_check" CHECK (("participation_role" = ANY (ARRAY['OWNER'::"text", 'EXECUTOR'::"text", 'REVIEWER'::"text", 'WATCHER'::"text"])))
);
...
ALTER TABLE "public"."workspace_statistics" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."series_tracker"
    ADD CONSTRAINT "series_tracker_pkey" PRIMARY KEY ("prefix", "financial_year", "month");
...
ALTER TABLE ONLY "public"."task_participants"
    ADD CONSTRAINT "task_participants_pkey" PRIMARY KEY ("task_id", "user_id");
...
ALTER TABLE ONLY "public"."workspace_statistics"
    ADD CONSTRAINT "workspace_statistics_pkey" PRIMARY KEY ("workspace_id");
...
CREATE INDEX "idx_task_deleted" ON "public"."tasks" USING "btree" ("is_deleted");
...
CREATE INDEX "idx_task_owner_id" ON "public"."tasks" USING "btree" ("owner_id");



CREATE INDEX "idx_task_parent_task_id" ON "public"."tasks" USING "btree" ("parent_task_id");
...
CREATE INDEX "idx_task_workspace_id" ON "public"."tasks" USING "btree" ("workspace_id");
...
CREATE INDEX "idx_workspace_deleted" ON "public"."workspaces" USING "btree" ("is_deleted");
...
CREATE INDEX "idx_workspace_parent_id" ON "public"."workspaces" USING "btree" ("parent_workspace_id");
...
CREATE INDEX "idx_workspace_type" ON "public"."workspaces" USING "btree" ("workspace_type");
...
CREATE OR REPLACE TRIGGER "trg_create_workspace_stats" AFTER INSERT ON "public"."workspaces" FOR EACH ROW EXECUTE FUNCTION "public"."create_workspace_stats"();



CREATE OR REPLACE TRIGGER "trg_sync_task_owner" AFTER INSERT OR UPDATE OF "owner_id" ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "public"."sync_task_owner_to_participants"();



CREATE OR REPLACE TRIGGER "trg_update_member_count" AFTER INSERT OR DELETE ON "public"."workspace_members" FOR EACH ROW EXECUTE FUNCTION "public"."update_member_count"();



CREATE OR REPLACE TRIGGER "trg_update_subworkspace_count" AFTER INSERT OR DELETE ON "public"."workspaces" FOR EACH ROW EXECUTE FUNCTION "public"."update_subworkspace_count"();



CREATE OR REPLACE TRIGGER "trg_update_task_count" AFTER INSERT OR DELETE ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "public"."update_task_count"();



CREATE OR REPLACE TRIGGER "trigger_set_task_code" BEFORE INSERT ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "public"."set_task_code"();



CREATE OR REPLACE TRIGGER "trigger_set_workspace_code" BEFORE INSERT ON "public"."workspaces" FOR EACH ROW EXECUTE FUNCTION "public"."set_workspace_code"();
...
ALTER TABLE ONLY "public"."sprints"
    ADD CONSTRAINT "sprints_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."user_master"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."task_participants"
    ADD CONSTRAINT "task_participants_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."task_templates"
    ADD CONSTRAINT "task_templates_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."user_master"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."task_templates"
    ADD CONSTRAINT "task_templates_default_priority_id_fkey" FOREIGN KEY ("default_priority_id") REFERENCES "public"."priority_master"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."workspace_statistics"
    ADD CONSTRAINT "workspace_statistics_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;
...
CREATE POLICY "Allow authenticated users to read statistics" ON "public"."workspace_statistics" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Super Admin Can Add Comments" ON "public"."task_comments" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_master"
  WHERE (("user_master"."id" = "auth"."uid"()) AND ("user_master"."role_id" = ( SELECT "roles"."id"
           FROM "public"."roles"
          WHERE ("roles"."code" = 'SUPER_ADMIN'::"text")
         LIMIT 1))))));



CREATE POLICY "Task Owners Can Add Comments" ON "public"."task_comments" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."tasks"
  WHERE (("tasks"."id" = "task_comments"."task_id") AND (("tasks"."owner_id" = "auth"."uid"()) OR ("tasks"."created_by" = "auth"."uid"()))))));



CREATE POLICY "Task Participants Can Add Comments" ON "public"."task_comments" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."task_participants"
  WHERE (("task_participants"."task_id" = "task_comments"."task_id") AND ("task_participants"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can manage sprints in their workspaces" ON "public"."sprints" USING ((("workspace_id" IN ( SELECT "workspace_members"."workspace_id"
   FROM "public"."workspace_members"
  WHERE ("workspace_members"."user_id" = "auth"."uid"()))) OR ("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."workspace_owner_id" = "auth"."uid"())))));



CREATE POLICY "Users can manage templates in their workspaces" ON "public"."task_templates" USING ((("workspace_id" IN ( SELECT "workspace_members"."workspace_id"
   FROM "public"."workspace_members"
  WHERE ("workspace_members"."user_id" = "auth"."uid"()))) OR ("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."workspace_owner_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can view sprints in their workspaces" ON "public"."sprints" FOR SELECT USING ((("workspace_id" IN ( SELECT "workspace_members"."workspace_id"
   FROM "public"."workspace_members"
  WHERE ("workspace_members"."user_id" = "auth"."uid"()))) OR ("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."workspace_owner_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can view templates in their workspaces" ON "public"."task_templates" FOR SELECT USING ((("workspace_id" IS NULL) OR ("workspace_id" IN ( SELECT "workspace_members"."workspace_id"
   FROM "public"."workspace_members"
  WHERE ("workspace_members"."user_id" = "auth"."uid"()))) OR ("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."workspace_owner_id" = "auth"."uid"())))));
...
CREATE POLICY "task_participants_select" ON "public"."task_participants" FOR SELECT TO "authenticated" USING ("public"."check_task_access"("task_id", "auth"."uid"()));
...
CREATE POLICY "tasks_strict_delete" ON "public"."tasks" FOR DELETE TO "authenticated" USING (("public"."is_super_admin"() OR ("owner_id" = "auth"."uid"())));



CREATE POLICY "tasks_strict_insert" ON "public"."tasks" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_super_admin"() OR (EXISTS ( SELECT 1
   FROM "public"."workspace_members" "wm"
  WHERE (("wm"."workspace_id" = "wm"."workspace_id") AND ("wm"."user_id" = "auth"."uid"()) AND ("wm"."is_deleted" = false))))));



CREATE POLICY "tasks_strict_select" ON "public"."tasks" FOR SELECT TO "authenticated" USING ("public"."check_task_access"("id", "auth"."uid"()));
...
CREATE POLICY "user_master_strict_select" ON "public"."user_master" FOR SELECT TO "authenticated" USING ((("id" = "auth"."uid"()) OR "public"."is_super_admin"() OR (EXISTS ( SELECT 1
   FROM ("public"."workspace_members" "wm1"
     JOIN "public"."workspace_members" "wm2" ON (("wm1"."workspace_id" = "wm2"."workspace_id")))
  WHERE (("wm1"."user_id" = "auth"."uid"()) AND ("wm2"."user_id" = "user_master"."id") AND ("wm1"."is_deleted" = false) AND ("wm2"."is_deleted" = false))))));



CREATE POLICY "user_master_super_admin_update" ON "public"."user_master" FOR UPDATE TO "authenticated" USING (("public"."is_super_admin"() OR ("id" = "auth"."uid"())));
...
CREATE POLICY "workspaces_strict_delete" ON "public"."workspaces" FOR DELETE TO "authenticated" USING (("public"."is_super_admin"() OR ("workspace_owner_id" = "auth"."uid"())));



CREATE POLICY "workspaces_strict_insert" ON "public"."workspaces" FOR INSERT TO "authenticated" WITH CHECK ("public"."is_super_admin"());



CREATE POLICY "workspaces_strict_select" ON "public"."workspaces" FOR SELECT TO "authenticated" USING (("public"."is_super_admin"() OR ("workspace_owner_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."workspace_members" "wm"
  WHERE (("wm"."workspace_id" = "workspaces"."id") AND ("wm"."user_id" = "auth"."uid"()) AND ("wm"."is_deleted" = false))))));



CREATE POLICY "workspaces_strict_update" ON "public"."workspaces" FOR UPDATE TO "authenticated" USING (("public"."is_super_admin"() OR ("workspace_owner_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."workspace_members" "wm"
  WHERE (("wm"."workspace_id" = "workspaces"."id") AND ("wm"."user_id" = "auth"."uid"()) AND ("wm"."role" = ANY (ARRAY['WORKSPACE_OWNER'::"text", 'WORKSPACE_MANAGER'::"text"])) AND ("wm"."is_deleted" = false))))));
...
GRANT ALL ON FUNCTION "public"."can_see_workspace"("p_workspace_id" "uuid", "p_owner_id" "uuid", "p_visibility_settings" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."can_see_workspace"("p_workspace_id" "uuid", "p_owner_id" "uuid", "p_visibility_settings" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_see_workspace"("p_workspace_id" "uuid", "p_owner_id" "uuid", "p_visibility_settings" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_workspace_stats"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_workspace_stats"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_workspace_stats"() TO "service_role";



GRANT ALL ON FUNCTION "public"."generate_series_code"("p_prefix" character varying) TO "anon";
GRANT ALL ON FUNCTION "public"."generate_series_code"("p_prefix" character varying) TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_series_code"("p_prefix" character varying) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."hierarchy_subws_count"("ws" "public"."workspaces") TO "anon";
GRANT ALL ON FUNCTION "public"."hierarchy_subws_count"("ws" "public"."workspaces") TO "authenticated";
GRANT ALL ON FUNCTION "public"."hierarchy_subws_count"("ws" "public"."workspaces") TO "service_role";



GRANT ALL ON FUNCTION "public"."hierarchy_task_count"("ws" "public"."workspaces") TO "anon";
GRANT ALL ON FUNCTION "public"."hierarchy_task_count"("ws" "public"."workspaces") TO "authenticated";
GRANT ALL ON FUNCTION "public"."hierarchy_task_count"("ws" "public"."workspaces") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."set_task_code"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_task_code"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_task_code"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_workspace_code"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_workspace_code"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_workspace_code"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."sync_task_owner_to_participants"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_task_owner_to_participants"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_task_owner_to_participants"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_subworkspace_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_subworkspace_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_subworkspace_count"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_task_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_task_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_task_count"() TO "service_role";
...
GRANT ALL ON TABLE "public"."series_tracker" TO "anon";
GRANT ALL ON TABLE "public"."series_tracker" TO "authenticated";
GRANT ALL ON TABLE "public"."series_tracker" TO "service_role";
...
GRANT ALL ON TABLE "public"."workspace_statistics" TO "anon";
GRANT ALL ON TABLE "public"."workspace_statistics" TO "authenticated";
GRANT ALL ON TABLE "public"."workspace_statistics" TO "service_role";
