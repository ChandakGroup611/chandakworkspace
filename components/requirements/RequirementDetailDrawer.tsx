    ...
    >
      <div className="grid grid-cols-3 gap-8">
          ...
          <h3 className="theme-label text-foreground">Technical Description & Scope</h3>
                  ...
                  <section className="theme-card-structural /40 rounded-2xl p-6 border-white/5">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between items-center theme-card-structural /40 p-3 rounded-xl border-white/5">
                  ...
                  {requirement.status?.status_name === 'UAT' && (
                    <section className="bg-amber-900/20 rounded-2xl p-6 border border-amber-500/20">
                      ...
                      <textarea 
                        className="w-full theme-card-structural /40 border-white/10 rounded-xl p-3 text-sm text-white mb-4 focus:outline-none focus:border-amber-500 theme-input-structural text-foreground"
            ...
            <div className="col-span-1 space-y-3">
              ...
              <div className="theme-card-structural /40 rounded-2xl p-5 border-white/5">
                ...
                <div className="space-y-3">
                  <div className="theme-data-value text-muted flex items-center gap-2 theme-card-structural /40 p-2 rounded-lg border-white/5">
