            ...
            <>
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 theme-card-structural dark:bg-[#151822] border-border dark:border-white/10 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary text-sm"
