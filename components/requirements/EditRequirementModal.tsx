  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-lg p-0 overflow-hidden">
        <DialogHeader className="px-6 py-4 border-b border-gray-200 dark:border-white/10 bg-gray-50/50 dark:theme-card-structural /[0.02]">
            ...
            <>
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 theme-card-structural dark:bg-[#151822] border-gray-300 dark:border-white/10 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary text-sm"
        ...
        <DialogFooter className="p-4 border-t border-gray-200 dark:border-white/10 bg-gray-50/50 dark:theme-card-structural /[0.02] flex justify-end gap-3">
