    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 relative">
          ...
          <div className={`hidden sm:flex items-center gap-2 rounded-xl border px-3 py-1.5 text-xs cursor-pointer transition-colors ${
            isLight 
              ? "bg-gray-50 border-gray-200 text-gray-700 hover:bg-gray-100" 
              : "bg-white/5 border-white/5 text-gray-300 hover:bg-white/10"
          }`}>
            <Layers className="h-3.5 w-3.5 text-indigo-400" />
            <span className="font-medium">Primary Ops Shell</span>
          ...
          <button className="flex items-center gap-1.5 rounded-xl bg-blue-600 px-3 py-2 text-xs font-semibold text-white shadow-lg shadow-blue-600/30 hover:bg-blue-500 transition-all active:scale-95">
