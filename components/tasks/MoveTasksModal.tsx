          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <select
                ...
                className="w-full text-sm theme-card-structural dark:bg-[#151923] text-foreground border-border dark:border-border rounded-lg px-3 py-2 outline-none focus:border-theme-btn-primary focus:ring-1 focus:ring-theme-btn-primary"
              >
