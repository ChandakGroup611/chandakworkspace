      ...
      <div className="bg-surface border border-border w-full max-w-4xl rounded-3xl shadow-2xl p-6 sm:p-7 space-y-5 max-h-[90vh] overflow-y-auto custom-scrollbar">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-border">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full px-3 py-2 text-xs rounded-xl border border-border bg-surface text-foreground font-bold focus:outline-none focus:border-teal-500 cursor-pointer shadow-2xs"
            >
              {ROLES.map(r => (
            ...
            <table className="w-full text-left text-xs border-collapse">
              ...
              <tbody className="divide-y divide-border/60">
                {MODULES.map(mod => {
                  ...
                  return (
                    <tr key={mod.code} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                        ...
                        <button
                          ...
                          className={`h-7 w-7 rounded-lg font-bold text-xs inline-flex items-center justify-center transition-all cursor-pointer ${
                            policy.canCreate 
                              ...
                              : "bg-slate-100 dark:bg-slate-800 text-muted-foreground/50 border border-border"
                      ...
                      <td className="p-3 text-right whitespace-nowrap">
                        ...
                        <button
                          ...
                          className="px-2 py-1 rounded-md text-[10px] font-bold text-muted-foreground hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer disabled:opacity-50"
                        >
                          Revoke
                        </button>
                      </td>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-3 border-t border-border text-xs">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl border border-border text-muted-foreground hover:text-foreground hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-xl border border-border bg-surface text-foreground font-semibold hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer"
            >
              Cancel
            </button>
            <button
